...
/**
 * An interface that act as a list
 * of mentions.
 * 
...
public interface MentionList extends List {
    ...
    /** Select mentions by type */
    public MentionList get(String type);

    /** Select mentions by a set of types. Expects a Set of String. */
    public MentionList get(Set types);
    
    /** Select mentions within start and end */
    public ArrayList getExact(Long start, Long end);    
    
    /** Select mentions beginning at start and finishing before end */
    public String[] getChildrenInside(RECKDPTreeNodeImpl node);

    /** Get the document this list is attached to. */
